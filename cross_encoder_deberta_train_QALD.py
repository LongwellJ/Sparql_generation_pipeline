...
weight_for_0 = 1 / (999416 / (999416 + 57900))
weight_for_1 = 1 / (57900 / (999416 + 57900))
...
train_filepath = f'../data/qald-9-plus/cross_encoder_QALD_filtered.json'
#val_filepath = f'../data/qald-9-plus/cross_encoder_QALD_testset_filtered.json'
...
#val_loader = DataLoader(valdataset, batch_size=256)
...
# Save model
model.save_pretrained('./cross_encoder_one_class_deberta')
