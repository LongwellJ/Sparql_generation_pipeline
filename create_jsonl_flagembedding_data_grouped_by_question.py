...
def process_input_data(input_data, neg_sample_size=19):
    ...
    for question, lists in data_by_question.items():
        ...
        # Randomly sample negatives if there are more than the desired sample size
        if len(neg_list) > neg_sample_size:
            neg_list = random.sample(neg_list, neg_sample_size)
...
#             "<http://dbpedia.org/resource/Category:Wasatch_Front>",
#             0
#         ],
#         "data": "What is the time zone of Salt Lake City? [SEP] subject: Salt Lake City, predicate: subject, object: Category:Wasatch Front",
#         "label": 0
#     },
#     {
#         "question": "What is the time zone of Salt Lake City?",
...
#             "<http://dbpedia.org/resource/Salt_Lake_City>",
#             "<http://purl.org/dc/terms/subject>",
#             "<http://dbpedia.org/resource/Category:County_seats_in_Utah>",
#             1
#         ],
#         "data": "What is the time zone of Salt Lake City? [SEP] subject: Salt Lake City, predicate: subject, object: Category:County seats in Utah",
#         "label": 1
#     },
#     {
#         "question": "What is the time zone of Salt Lake City?",
...
#             "<http://dbpedia.org/resource/Salt_Lake_City>",
#             "<http://purl.org/dc/terms/subject>",
#             "<http://dbpedia.org/resource/Category:1847_establishments_in_Utah>",
#             0
#         ],
#         "data": "What is the time zone of Salt Lake City? [SEP] subject: Salt Lake City, predicate: subject, object: Category:1847 establishments in Utah",
#         "label": 0
#     }
# ]
